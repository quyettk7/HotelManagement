...
<head>
    ...
    <title>Quản lý Vai trò | Luxury Hotel</title>
    <!-- Google Fonts - Inter -->
    ...
    <div class="row">
        ...
        <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse" id="navbarNav">
            <div class="position-sticky pt-3">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="${pageContext.request.contextPath}/admin/roles">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2">Quản lý Vai trò</h1>
            </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-8">
                    <div class="card p-4">
                        <h5 class="card-title mb-4">Danh sách Vai trò</h5>
                            ...
                            <table class="table table-hover align-middle mb-0">
                                ...
                                <tbody>
                                    <c:forEach var="item" items="${roleList}">
                                        <tr>
                                            <td><strong>#${item.roleId}</strong></td>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group" role="group">
                                                    <a href="${pageContext.request.contextPath}/admin/roles?action=edit&id=${item.roleId}" class="btn btn-sm btn-outline-primary" title="Sửa">
                                                        <i class="bi bi-pencil-square"></i>
                                                    </a>
                                                    <c:if test="${item.roleId > 4}"> <!-- Prevents deleting system roles (Admin, Manager, Staff, Customer) -->
                                                        <a href="${pageContext.request.contextPath}/admin/roles?action=delete&id=${item.roleId}" 
                                                           class="btn btn-sm btn-outline-danger" 
                                                           onclick="return confirm('Bạn có chắc chắn muốn xóa vai trò này không?');" title="Xóa">
                ...
                <div class="col-lg-4">
                    <div class="card p-4">
                        <h5 class="card-title mb-4">${not empty role ? 'Cập nhật Vai trò' : 'Thêm vai trò mới'}</h5>
                        <form action="${pageContext.request.contextPath}/admin/roles" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="roleName" name="roleName" 
                                       value="${role.roleName}" required placeholder="Ví dụ: Receptionist">
                            </div>

                            <div class="mb-3">
                                <label for="description" class="form-label">Mô tả</label>
                                <textarea class="form-control" id="description" name="description" rows="3" 
                                          placeholder="Nhập mô tả vai trò...">${role.description}</textarea>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="form-check form-switch mt-1">
                                    <input class="form-check-input" type="checkbox" id="status" name="status" value="true"
                                           <c:if test="${empty role || role.status}">checked</c:if>>
                                    <label class="form-check-label" for="status">Hoạt động / Cho phép sử dụng</label>
                                </div>
                            </div>
                            ...
                            <div class="d-grid gap-2">
                                ...
                                <c:if test="${not empty role}">
                                    <a href="${pageContext.request.contextPath}/admin/roles" class="btn btn-outline-secondary">
                                        Hủy chỉnh sửa
                                    </a>
                                </c:if>
                            </div>
