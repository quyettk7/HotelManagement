        ...
        <body>
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
                <div class="container-fluid">
                    ...
                    <button class="navbar-expand-toggle navbar-toggler" type="button" data-bs-toggle="collapse"
                ...
                <div class="row">
                    ...
                    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                        ...
                        <div class="alert alert-success alert-dismissible fade show shadow-sm" role="alert"
                            ...
                            <strong>Chào mừng quay trở lại, ${currentUser.fullName}!</strong> Bạn đã đăng nhập thành
                            công với quyền <strong>${currentUser.roleName}</strong>.
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <h6 class="text-uppercase mb-1"
                                                    style="font-size: 0.8rem; letter-spacing: 1px;">Phòng trống</h6>
                                                <h2 class="mb-0">12</h2>
                                            </div>
                                ...
                                <div class="card stat-card bg-success text-white h-100">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <h6 class="text-uppercase mb-1"
                                                    style="font-size: 0.8rem; letter-spacing: 1px;">Yêu cầu đặt phòng
                                                </h6>
                                                <h2 class="mb-0">5</h2>
                                            </div>
                                ...
                                <div class="card stat-card bg-warning text-dark h-100">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <h6 class="text-uppercase mb-1"
                                                    style="font-size: 0.8rem; letter-spacing: 1px;">Doanh thu tháng này
                                                </h6>
                                ...
                                <div class="card stat-card bg-danger text-white h-100">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <h6 class="text-uppercase mb-1"
                                                    style="font-size: 0.8rem; letter-spacing: 1px;">Đang sử dụng dịch vụ
                                                </h6>
                                                <h2 class="mb-0">8</h2>
                                            </div>
                        ...
                        <div class="mt-5 p-5 bg-white border rounded shadow-sm text-center"
                            ...
                            <p class="text-muted">Các tính năng quản lý chi tiết sẽ được phát triển ở những bước tiếp
                                theo theo đúng thứ tự quy trình.</p>
                        </div>
                    </main>
                </div>
            </div>
